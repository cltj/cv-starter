# YOLO Open Images V7 Classes (601) — yolov8n-oiv7.pt

Model: `yolov8n-oiv7.pt` (YOLOv8 nano, trained on Open Images V7 dataset)

This model supports 601 classes including clothing, body parts, and many more categories
not found in the standard COCO model (80 classes).

To use this model, change `main.py`:
```python
model = YOLO("yolov8n-oiv7.pt")
```

See also: [yolo-coco-classes.md](yolo-coco-classes.md) for the 80-class COCO model.
